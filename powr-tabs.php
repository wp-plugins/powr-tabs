<?php
    ...
    Description: Instantly add beautiful navigation tabs to any site! Add the widget to your theme, or create a Tabs on ANY page or post by using the shortcode [powr-tabs]. Then, simply visit your site and click the settings icon to customize your Tabs right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.1
    ...
    */
    ...
    class Powr_Tabs extends WP_Widget{
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Tabs.
        </p>
        <p>
